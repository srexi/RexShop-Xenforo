...
class ExpireSubscriptions extends AbstractJob
{
    public function run($maxRunTime)
    {
        ...
        $subscriptions = ($db->query(
            "SELECT r.expired, r.enddate, r.transaction_status, u.user_id FROM xf_rexshop_logs r
        ...
        foreach ($subscriptions as $subscription) {
            ...
            $db->query("UPDATE xf_rexshop_logs SET expired = ? WHERE uid = ?", [1, $subscription['user_id']]);
        }
